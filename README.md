...
- **Ayuda integrada** — bienvenida en la primera visita, tour guiado de 9 pasos por las pantallas, video de recorrido narrado (3 min) con subtítulos y capítulos, y chat de ayuda (botón flotante) que explica cómo hacer cada cosa y lleva a la pantalla correcta.
